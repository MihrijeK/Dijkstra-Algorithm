...
public class GraphPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public void mouseClicked(MouseEvent e) {
                ...
                if (SwingUtilities.isLeftMouseButton(e)) {
                    if (!graph.isDestination(selected))
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Nuk mund te vendoset nyja e destinacionit si nyje burimore");
                } else if (SwingUtilities.isRightMouseButton(e)) {
                    if (!graph.isSource(selected))
                        graph.setDestination(selected);
                    else
                        JOptionPane.showMessageDialog(null,
                                "Nuk mund te vendoset nyja burimore si nyje e destinacionit");
                } else
                    return;
        ...
        if (hoveredEdge != null) {
            ...
            String input = JOptionPane.showInputDialog("Peshe per " + hoveredEdge.toString() + " : ");
            try {
                ...
                if (weight > 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "Pesha duhet te jete pozitive");
                }
        ...
        for (Node node : graph.getNodes()) {
            if (DrawUtils.isOverlapping(e, node.getCoord())) {
                JOptionPane.showMessageDialog(null, "Nuk mund te krijoni nyje");
                return;
            }
        }
